...
def subblock_interleaver(indices, N):
    """
    Apply the interleaver to the given reliability indices.
    """
    ...
    for i in interleaver_map:
        interleaved_indices.extend(indices[i * sequence_length:(i + 1) * sequence_length])
